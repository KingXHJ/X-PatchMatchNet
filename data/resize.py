...
file_path = r"D:\Recent_things\CVlifeMVS-modified\DeepLearningMVS\PatchmatchNet-main\data\test2\imagesCut"    # 原始图像路径

raw_files = os.walk(file_path)              # 遍历所有图像
width, height = 1280, 720                   # 修改后的图像尺寸大小

save_path = r"D:\Recent_things\CVlifeMVS-modified\DeepLearningMVS\PatchmatchNet-main\data\test2\imagesResize"  # 修改后图像存储的路径
